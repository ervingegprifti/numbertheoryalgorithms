...
public class QuadraticFormRun1 extends Algorithm implements GridCalculator {
    private final static String TAG = QuadraticFormRun1.class.getSimpleName();


    public QuadraticFormRun1(AlgorithmParameters algorithmParameters) {
        ...
        try {
            ...
            for(BigInteger i = ZERO; i.compareTo(f) <= 0; i = i.add(ONE)) {
                ...
                for (BigInteger x = ZERO; x.compareTo(maxX) <= 0; x = x.add(ONE)) {
                    ...
                    String resultXFixed = SQFSolutionXFixed(b, d, e, i, x);
                ...
                // Last column values.
                String resultSQFRun1 = SQFRun1(b, d, e, i);
    ...
    private String SQFRun1(BigInteger b, BigInteger d, BigInteger e, BigInteger f) throws InterruptedException {
        ...
        List<Pair<BigInteger, BigInteger>> pairFactors = AlgorithmHelper.PairFactors(n, true);
        ...
        List<Solution> solutions = AlgorithmHelper.SQFSolutions(b,d,e,pairFactors, true, false);
    ...
    static String SQFSolutionXFixed (BigInteger b, BigInteger d, BigInteger e, BigInteger f, BigInteger x) throws InterruptedException {
        BigInteger y = ZERO;
