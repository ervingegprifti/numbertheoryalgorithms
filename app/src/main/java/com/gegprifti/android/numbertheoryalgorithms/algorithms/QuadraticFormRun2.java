...
public class QuadraticFormRun2 extends Algorithm implements GridCalculator {
    private final static String TAG = QuadraticFormRun2.class.getSimpleName();


    public QuadraticFormRun2(AlgorithmParameters algorithmParameters) {
