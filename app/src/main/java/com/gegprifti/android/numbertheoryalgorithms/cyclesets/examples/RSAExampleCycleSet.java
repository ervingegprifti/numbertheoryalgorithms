...
public class RSAExampleCycleSet implements CycleSet {
    private final List<RSAExample> rsaExampleList;
    private int index = 0;


    // <!--₀ ₁ ₂ ₃ ₄ ₅ ₆ ₇ ₈ ₉-->
    // https://en.wikipedia.org/wiki/RSA_Factoring_Challenge
    public RSAExampleCycleSet() {
        List<RSAExample> rsaExampleList = new ArrayList<>();

        // https://en.wikipedia.org/wiki/RSA_numbers#RSA-100
        RSAExample rsaExample100 = new RSAExample.Builder()
                .name("RSA₁₀₀")
                ...
                .build();
        rsaExampleList.add(rsaExample100);

        // https://en.wikipedia.org/wiki/RSA_numbers#RSA-110
        RSAExample rsaExample110 = new RSAExample.Builder()
                .name("RSA₁₁₀")
                ...
                .build();
        rsaExampleList.add(rsaExample110);

        // https://en.wikipedia.org/wiki/RSA_numbers#RSA-120
        RSAExample rsaExample120 = new RSAExample.Builder()
                .name("RSA₁₂₀")
                ...
                .build();
        rsaExampleList.add(rsaExample120);

        // https://en.wikipedia.org/wiki/RSA_numbers#RSA-129
        RSAExample rsaExample129 = new RSAExample.Builder()
                .name("RSA₁₂₉")
                ...
                .build();
        rsaExampleList.add(rsaExample129);

        // https://en.wikipedia.org/wiki/RSA_numbers#RSA-130
        RSAExample rsaExample130 = new RSAExample.Builder()
                .name("RSA₁₃₀")
                ...
                .build();
        rsaExampleList.add(rsaExample130);

        // https://en.wikipedia.org/wiki/RSA_numbers#RSA-140
        RSAExample rsaExample140 = new RSAExample.Builder()
                .name("RSA₁₄₀")
                ...
                .build();
        rsaExampleList.add(rsaExample140);

        // https://en.wikipedia.org/wiki/RSA_numbers#RSA-150
        RSAExample rsaExample150 = new RSAExample.Builder()
                .name("RSA₁₅₀")
                ...
                .build();
        rsaExampleList.add(rsaExample150);

        this.rsaExampleList = Collections.unmodifiableList(rsaExampleList);
    }


    @Override
    public Object next() {
        if (this.rsaExampleList.isEmpty()) {
            return null;
        }
        RSAExample rsaExample = this.rsaExampleList.get(index);
        this.index = (this.index + 1) % this.rsaExampleList.size();
        return rsaExample;
    }
}
