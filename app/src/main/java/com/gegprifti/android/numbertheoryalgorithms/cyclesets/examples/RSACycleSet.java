...
public class RSACycleSet implements CycleSet {
    ...
    public RSACycleSet() {
        ...
        RSA rsa190 = new RSA.Builder()
                .name("RSA₁₉₀")
                .reference("https://en.wikipedia.org/wiki/RSA_numbers#RSA-190")
                .n(new BigInteger("1907556405060696491061450432646028861081179759533184460647975622318915025587184175754054976155121593293492260464152630093238509246603207417124726121580858185985938946945490481721756401423481"))
                .p(new BigInteger("31711952576901527094851712897404759298051473160294503277847619278327936427981256542415724309619"))
                .q(new BigInteger("60152600204445616415876416855266761832435433594718110725997638280836157040460481625355619404899"))
                .build();
        elements.add(rsa190);

        RSA rsa193 = new RSA.Builder()
                .name("RSA₁₉₃")
                .reference("https://en.wikipedia.org/wiki/RSA_numbers#RSA-640")
                .n(new BigInteger("3107418240490043721350750035888567930037346022842727545720161948823206440518081504556346829671723286782437916272838033415471073108501919548529007337724822783525742386454014691736602477652346609"))
                .p(new BigInteger("1634733645809253848443133883865090859841783670033092312181110852389333100104508151212118167511579"))
                .q(new BigInteger("1900871281664822113126851573935413975471896789968515493666638539088027103802104498957191261465571"))
                .build();
        elements.add(rsa193);
