...
public class AlgorithmHelper {
    ...
    public static List<Solution> SQFSolutions (BigInteger b, BigInteger d, BigInteger e, List<Pair<BigInteger, BigInteger>> pairFactors, boolean includeOnlyPositiveSolutions, boolean includeOnlyNegativeSolutions) throws InterruptedException {
    ...
    public static List<Pair<BigInteger, BigInteger>> PairFactors(BigInteger n, boolean includeTrivialSolutions) throws InterruptedException {
