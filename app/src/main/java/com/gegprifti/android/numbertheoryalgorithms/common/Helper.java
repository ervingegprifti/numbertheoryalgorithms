...
public final class Helper {
    ...
    public static void CustomToastError(Context context, String message) {
        CustomToastError(context, message, Toast.LENGTH_LONG);
    }
    public static void CustomToastError(Context context, String message, int toastLength) {
        try {
    ...
    public static void CustomToastLight(Context context, String message) {
        CustomToastLight(context, message, Toast.LENGTH_LONG);
    }
    public static void CustomToastLight(Context context, String message, int toastLength) {
        try {
            LayoutInflater inflater = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            assert inflater != null;
    ...
    public static void CustomToastDark(Context context, String message) {
        CustomToastDark(context, message, Toast.LENGTH_LONG);
    }
    public static void CustomToastDark(Context context, String message, int toastLength) {
        try {
            LayoutInflater inflater = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            assert inflater != null;
    ...
    public static void CopyTextToClipboard(Context context, String textToCopyToClipboard) {
        ...
        try {
            ...
            if(textToCopyToClipboard.isEmpty()) {
                Vibrate(context);
                CustomToastLight(context, "Nothing to copy", Toast.LENGTH_SHORT);
            } else {
                ClipboardManager clipboardManager = (ClipboardManager)context.getSystemService(Context.CLIPBOARD_SERVICE);
                if(clipboardManager == null) {
                    return;
                ...
                clipboardManager.setPrimaryClip(clipData);
                Vibrate(context);
                CustomToastLight(context, textToCopyToClipboard + " copied", Toast.LENGTH_SHORT);
            }
        } catch (Exception ex) {
            Log.e(TAG, "" + ex);
        }
    ...
    public static void shareApp(Context context, String shareAppSubject, String shareAppUrl, String shareAppChooser) {
        try {
            ...
            if(intent.resolveActivity(context.getPackageManager()) != null) {
                ...
                CustomToastLight(context, "There is no application to share this kind of information");
            }
        } catch(Exception ex) {
            Log.e(TAG, "" + ex);
        }
    ...
    public  static void NotifyOnClipboardButtonClick(Context context, String message) {
        try {
            ...
            if (notifyOnClipboardButtonClick) {
                CustomToastLight(context, message, Toast.LENGTH_SHORT);
            }
        } catch (Exception ex) {
            Log.e(TAG, "" + ex);
        }
