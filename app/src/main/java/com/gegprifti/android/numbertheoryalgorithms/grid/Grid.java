...
public class Grid {
    ...
    private  List<Integer> columnMaxLengths;
    ...
    public List<Integer> getColumnMaxLengths() {
     ...
     */
    public Grid(List<List<Cell>> corner, List<List<Cell>> columnHeaders, List<List<Cell>> rowHeaders, List<List<Cell>> rows, List<Integer> columnMaxLengths) {
        this.corner = corner;
