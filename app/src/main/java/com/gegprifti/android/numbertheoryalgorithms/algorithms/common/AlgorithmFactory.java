...
public class AlgorithmFactory {
    ...
    static {
        ...
        registry.put(AlgorithmName.QUADRATIC_FORM, QuadraticFormRun::new);
        registry.put(AlgorithmName.QUADRATIC_FORM_1, QuadraticFormRun1::new);
        registry.put(AlgorithmName.QUADRATIC_FORM_2, QuadraticFormRun2::new);
