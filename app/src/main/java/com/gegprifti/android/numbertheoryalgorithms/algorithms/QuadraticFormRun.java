...
public class QuadraticFormRun extends Algorithm implements StringCalculator {
    private final static String TAG = QuadraticFormRun.class.getSimpleName();


    public QuadraticFormRun(AlgorithmParameters algorithmParameters) {
    ...
    public String calculate() throws InterruptedException {
        ...
        try {
            ...
            List<Pair<BigInteger, BigInteger>> pairFactors = AlgorithmHelper.PairFactors(n, includeTrivialSolutions);
            ...
            List<Solution> solutions = AlgorithmHelper.SQFSolutions(b,d,e,pairFactors, includeOnlyPositiveSolutions, includeOnlyNegativeSolutions);
