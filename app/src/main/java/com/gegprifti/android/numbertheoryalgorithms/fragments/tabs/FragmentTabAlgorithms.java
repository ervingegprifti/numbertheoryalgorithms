...
import com.gegprifti.android.numbertheoryalgorithms.fragments.FragmentLinearCongruenceInTwoVariables;
import com.gegprifti.android.numbertheoryalgorithms.fragments.FragmentLinearDiophantineEquationInTwoVariables;
import com.gegprifti.android.numbertheoryalgorithms.fragments.FragmentModFactors;
import com.gegprifti.android.numbertheoryalgorithms.fragments.FragmentPrimesList;
import com.gegprifti.android.numbertheoryalgorithms.fragments.FragmentQuadraticForm;
...
public class FragmentTabAlgorithms extends Fragment {
    ...
    private void SetupSectionsPagerAdapter() {
        try {
            ...
            FragmentQuadraticForm fragmentQuadraticForm = new FragmentQuadraticForm();
            fragmentQuadraticForm.setFragmentTabAlgorithms(this); // Set the parent
            sectionsPagerAdapter.addFragment(fragmentQuadraticForm, "FragmentQuadraticForm"); // Simple Quadratic Form
